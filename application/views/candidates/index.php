        ...
        <section id="policy">
            <div class="wrap">
                ...
                <article class="container_12 content">
                    ...
                    <div class="grid_8">
                        ...
                        <a href="<?php echo base_url(); ?>profiles/upload_cv" class="button transparent-blue"><span>Upload CV</span></a>
                    </div>
                </article>
            ...
            <div class="wrap">
                ...
                <article class="container_12 content">
                    ...
                    <div class="grid_8">
                        <p>Sed magna purus, fermentum eu, tincidunt eu, varius ut, felis. In auctor lobortis lacus. Quisque libero metus, <strong>condimentum</strong> nec, tempora, commodo mollis, magna. Vestibulum ullamcorper mauris at ligula. Fusce fermentum. Nullam cursus lacinia erat. Praesent blandit laoreet nibh. Fusce convallis metus id felis luctus adipiscing.</p>
                        <a href="about.html" class="button transparent-green"><span>Test Results</span></a>
                        <a href="about.html" class="button transparent-blue"><span>Take Free Sample Test</span></a>
                    </div>
                </article>
                <footer class="content-footer"></footer>
            </div>
