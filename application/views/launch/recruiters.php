        ...
        <section id="home">
            <div class="wrap inverse extra-overlay vpadding-strong top">
                ...
                <article class="container_12 content aligned center">
                    <div class="grid_6">
                        <h1 class="huge">Looking To Recruit?</h1>
                        <p class="light-gray">Sign up today to post your jobs and test your next candidates<br>
                        Find quality geeks with our tests.</p>
                    </div>
            ...
            <div class="wrap vpadding-large">
                <article class="container_12 content aligned">
                    <div class="grid_6">
                        ...
                        <form action="<?php echo base_url(); ?>launch/recruiter_login" method="post">
                    ...
                    <div class="grid_6">
                        ...
                        <form action="<?php echo base_url(); ?>launch/recruiter_register" method="post">
                                <label>Email Address</label>
